...
mydata<-readRDS("/data/TBrnaseq.rds")
...
ph<-data.frame(read_excel("/data/phenotype.xls"))
...
sink("/results/GranulomeModules.gmt")
...
ModuleGeneSets = read.gmt("/results/GranulomeModules.gmt")
...
WriteXLS("Stats","/results/QusageModuleEnrichment.xls")